const translations = {
  ...
  AUTH: {
    ...
    SIGNUP: {
      ...
      ALERT_NAME_TAKEN: {
        ...
        lt: "Vardas jau naudojama. Prašome pasirinkti kitą vardą.",
      },
      ALERT_LANGUAGE_CLASH: {
        ...
        lt: "Mokymosi kalba ir kalba, kuriai atliksite vertimus, negali būti vienodi.",
      },
    },
    SIGNIN: {
      TITLE: {
      ...
      ALERT_DATA_RESTORED: {
        ...
        lt: "Duomenys atkurti. Gerai žaisti",
      },
    },
  },
  LIBRARY: {
    ...
    ALERT_ADD_STORY: {
      en: "Adding stories not implemented yet 😞",
      es: "De momento no se pueden añadir más historias 😞",
      ca: "De moment no es poden afegir més històries 😞",
      lt: "Kol kas negalima pridėti daugiau istorijų 😞",
    },
    ALERT_REMOVED_STORY: {
      en: "Story removed successfully!",
      es: "¡Historia eliminada con éxito!",
      ca: "Història eliminada amb èxit!",
  ...
  FILTER: {
    ...
    NUM_STORIES: {
      ...
      es: "Número de historias",
      ca: "Nombre d'històries",
  ...
  EDIT: {
    ...
    ALERT_STORY_UPDATED: {
      ...
      ca: "Història actualitzada",
      lt: "Istorija atnaujinta",
    },
    ALERT_INVALID_STORY: {
      en: "Invalid story",
      es: "Historia inválida",
      ca: "Història invàlida",
